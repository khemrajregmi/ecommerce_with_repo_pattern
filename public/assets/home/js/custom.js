...
jQuery(function($j) {
	...
	function removeAllFromCompare() {
		...
		var list = $j('.compare-box__items__list');
		var addEmptyRow = '<li class="compare-box__items__list__item empty"><div class="compare-box__items__list__item__num"></div><img src="images/products/product-empty.png" alt="Product Empty"/></li>';
		item.each(function() {
...
jQuery(function($j) {
	...
	// 	 alert('hello cart -- assets/home/js/custom.js--line no.2605');
...
jQuery(function($j) {
    ...
    "use strict";
	$j('.kerung-wishlist').on('click',function(e){
		e.preventDefault();
		alert('kerung wishlist -- assets/home/js/custom.js--line no.2891');
	});
...
jQuery(function($j) {
    "use strict";
	$j('.kerung-compare').on('click',function(e){
		e.preventDefault();
		alert('kerung compare --- assets/home/js/custom.js--line no.2903');
	});
});

...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Length Classes</small></h2>
                    <div class="pull-right">
                    <a href="{{route('admin.lengthclass.create')}}" class="btn btn-info btn-md">
                ...
                <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                        ...
                        <tbody>
                        @foreach($lengthclasses as $ls)
                        <tr>
                            <td><input type="checkbox" class="flat" value="{{$ls->length_class_id}}" name="table_records"></td>
                            <td>{{$ls->title}}</td>
                            <td>{{$ls->unit}}</td>
                            <td>{{$ls->value}}</td>
                            <td><a href="{{route('admin.lengthclass.edit',$ls->length_class_id)}}" class="btn btn-default btn-sm">

        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="{{route('admin.category.importexport')}}" class="btn btn-info btn-md">Import/Export
                    </a>
                    <a href="{{route('admin.category.create')}}" class="btn btn-info btn-md">
                ...
                <div class="x_content">
                  ...
                  <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                        ...
                        <tr> 
                            <td><input type="checkbox" class="flat" value="{{$c->category_id}}" name="table_records"></td>
                            <td>{{$c->name}}</td>
                            <td><?php
                                    if ($c->status==0) 
                                        echo "Disable";
                                ...
                                ?></td>
                            <td>
                                <a href="{{route('admin.category.show',$c->category_id)}}" data-toggle="tooltip" title="View Detail" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                <a href="{{route('admin.category.edit',$c->category_id)}}" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> Edit
                                </a>
                            </td>
                        </tr>
                        @endforeach

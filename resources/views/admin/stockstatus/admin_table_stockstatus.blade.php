...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Stock Status List</small></h2>
                    <div class="pull-right">
                    <a href="{{route('admin.stockstatus.create')}}" class="btn btn-info btn-md">
                ...
                <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                        ...
                        <tr>
                            <td><input type="checkbox" class="flat" value="{{$ss->stock_status_id}}" name="table_records"></td>
                            <td>{{$ss->name}}</td>
                            <td><a href="{{route('admin.stockstatus.edit',$ss->stock_status_id)}}" class="btn btn-default btn-sm">

...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Weight Classes List</small></h2>
                    <div class="pull-right">
                    <a href="{{route('admin.weightclass.create')}}" class="btn btn-info btn-md">
                ...
                <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                        ...
                        <tbody>
                        @foreach($weightclasses as $ws)
                        <tr>
                            <td><input type="checkbox" class="flat" value="{{$ws->weight_class_id}}" name="table_records"></td>
                            <td>{{$ws->title}}</td>
                            <td>{{$ws->unit}}</td>
                            <td>{{$ws->value}}</td>
                            <td><a href="{{route('admin.weightclass.edit',$ws->weight_class_id)}}" class="btn btn-default btn-sm">
                ...
                if(!$("input:checkbox").is(":checked")){
                    ...
                    if(confirm("Are you sure you want to delete ??")){
                        ...
                        $.each($("input[name='table_records']:checked"), function(){
                            weight_class_id.push($(this).val());
                        });
                        console.log(weight_class_id);


                        /** Delete data ***/
                        $.ajax({
                            type: "DELETE",
                            url: "weightclass/" + weight_class_id,
                            data:{
                                "_token":"{{csrf_token()}}"
                            },

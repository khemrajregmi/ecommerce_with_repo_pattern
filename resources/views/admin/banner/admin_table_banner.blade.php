...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Banner List</small></h2>
                    <div class="pull-right">
                    <a href="{{route('admin.banner.create')}}" class="btn btn-info btn-md">
                ...
                <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                        ...
                        @foreach($banner as $b)
                        <tr>
                            <td><input type="checkbox" class="flat" value="{{$b->banner_id}}" name="table_records"></td>
                            <td>{{$b->name}}</td>
                             <td><?php
                                    if ($b->status==1) 
                                        echo "Enable";
                            ...
                            <td><a href="{{route('admin.banner.edit',$b->banner_id)}}" class="btn btn-default btn-sm">
